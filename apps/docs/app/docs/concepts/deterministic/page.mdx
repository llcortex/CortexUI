...
4. **Runtime API** — `window.__CORTEX_UI__` provides a programmatic interface for discovering and querying all declared elements
...
- [Testing with CortexUI](/docs/getting-started/first-component)
