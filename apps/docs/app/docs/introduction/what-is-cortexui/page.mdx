...
3. A runtime inspection API (`window.__CORTEX_UI__`) for querying and operating on the interface
...
- [Why CortexUI — the problem it solves](/docs/introduction/why-cortexui)
- [The CortexUI philosophy](/docs/introduction/philosophy)
