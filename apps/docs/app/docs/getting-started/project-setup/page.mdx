...
After [installing the CortexUI packages](/docs/getting-started/installation), you need to configure your application to activate the full CortexUI system. This involves two required steps and several optional steps.
...
| `@cortexui/tokens` CSS import | Optional | Design token CSS variables |
